...
(llama-defun estimate-memory (model &key n-ctx type-k type-v)
...
(llama-defun explain-memory-usage (model &key n-ctx type-k type-v
...
(llama-defun validate-configuration (model &key n-ctx type-k type-v
...
(llama-defun feasibility-report (model &key n-ctx type-k type-v n-gpu-layers vram-budget
                                      (stream *standard-output*))
...
(llama-defun suggest-configuration (model &key n-ctx n-gpu-layers vram-budget)

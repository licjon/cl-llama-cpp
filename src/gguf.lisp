...
(llama-defun gguf-val (gguf key-id)
...
(llama-defun gguf-arr-data (gguf key-id)
...
(llama-defun gguf-arr-str (gguf key-id index)
...
(llama-defun gguf-tensor-offset (gguf tensor-id)
